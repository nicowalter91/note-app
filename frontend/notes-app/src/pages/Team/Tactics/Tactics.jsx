...
const Tactics = () => {
    ...
    const getCategoryColor = (category) => {
        switch (category) {
            case 'Offensiv': return 'text-green-600 bg-green-100 dark:bg-green-900 dark:text-green-300';
            case 'Defensiv': return 'text-red-600 bg-red-100 dark:bg-red-900 dark:text-red-300';
            case 'Aufbau': return 'text-blue-600 bg-blue-100 dark:bg-blue-900 dark:text-blue-300';
